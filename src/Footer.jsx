    ...
    <div class="mx-auto">
        <div class="flex justify-between max-md:flex-col max-md:justify-around">
            ...
            <div class="grid grid-cols-1 gap-5 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <Link to={'/initiatives'} class="hover:underline">Initiatives</Link>
                        </li>
                        <li class="mb-4">
                            <Link to={'/challenges'} class="hover:underline">Challenges</Link>
                        </li>
                        <li class="mb-4">
                            <p>Community</p>
                        </li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 max-md:justify-center space-x-6">
                ...
                <a href="https://instagram.com" target='_blank' class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
